        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-3 flex flex-col gap-6">
            ...
            <div className="neu-flat-base p-6 flex flex-col gap-2">
              ...
              <h4 className="text-3xl font-black text-[var(--secondary)] pl-2">{totalMandates}</h4>
            </div>
          </div>
          ...
          <div className="lg:col-span-3 flex flex-col gap-4">
            ...
            <div className="neu-flat-base p-5 flex flex-col gap-2">
              <span className="text-[10px] text-[var(--secondary)]/60 font-bold uppercase tracking-wider flex items-center gap-1.5">
                <MapPin size={14} className="text-[var(--accent)]" /> Operating Region
              </span>
            ...
            <div className="neu-flat-base p-5 flex flex-col gap-2">
              <span className="text-[10px] text-[var(--secondary)]/60 font-bold uppercase tracking-wider flex items-center gap-1.5">
                <DollarSign size={14} className="text-[var(--accent)]" /> Target Ticket
              </span>
              <span className="text-xl font-black text-[var(--secondary)] pl-1">{profile?.ticket_size || "Flexible"}</span>
            </div>

            <div className="neu-flat-base p-5 flex flex-col gap-2">
              <span className="text-[10px] text-[var(--secondary)]/60 font-bold uppercase tracking-wider flex items-center gap-1.5">
                <Briefcase size={14} className="text-[var(--accent)]" /> Sector Focus
              </span>
              <span className="text-xl font-black text-[var(--secondary)] truncate pl-1">{profile?.industries_of_interest?.[0] || "Agnostic"}</span>
            </div>
          </div>
