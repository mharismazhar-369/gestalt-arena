...
export default async function PitchDeckView({ params }: { params: Promise<{ id: string }> }) {
    // Unwrap the params Promise required by Next.js 15+
    ...
    // Fetch the actual pitch deck from the live database using the awaited id
            ...
            <main className="pt-32 pb-40 px-6 mx-auto max-w-6xl w-full relative z-10 space-y-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="trionn-glass-card p-6 rounded-2xl border border-white/10 space-y-2">
                        ...
                        <p className="text-xl font-bold text-white">{pitchDeck.funding_goal || "Flexible"}</p>
                    </div>
                    <div className="trionn-glass-card p-6 rounded-2xl border border-white/10 space-y-2">
                        ...
                        <p className="text-xl font-bold text-white">{pitchDeck.min_ticket || "$10k"}</p>
                    </div>
                    <div className="trionn-glass-card p-6 rounded-2xl border border-white/10 space-y-2">
                        ...
                        <p className="text-xl font-bold text-white">{pitchDeck.valuation || "TBD"}</p>
                    </div>
                    <div className="trionn-glass-card p-6 rounded-2xl border border-white/10 space-y-2">
