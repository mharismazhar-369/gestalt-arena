    ...
    <div className="min-h-screen bg-[var(--primary)] text-[var(--secondary)] flex flex-col justify-between relative transition-colors duration-300">
      ...
      <main className="pt-32 pb-24 px-6 mx-auto max-w-[1440px] w-full relative z-10 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          {/* LEFT SIDEBAR: Action Cards & Metrics */}
          <div className="lg:col-span-3 flex flex-col gap-6">
            ...
            <div className="neu-flat-base p-6 flex flex-col gap-2">
              <div className="flex items-center gap-3 mb-2">
                <div className="neu-pressed-base p-2 text-[var(--accent)] rounded-full"><Folder size={20} /></div>
                <p className="text-xs text-[var(--secondary)]/70 font-bold uppercase tracking-wider">Fundraising Opps</p>
              </div>
              <h4 className="text-3xl font-black text-[var(--secondary)] pl-2">{totalDeals}</h4>
            </div>

            <div className="neu-flat-base p-6 flex flex-col gap-2">
              <div className="flex items-center gap-3 mb-2">
                <div className="neu-pressed-base p-2 text-[var(--accent)] rounded-full"><FileText size={20} /></div>
                <p className="text-xs text-[var(--secondary)]/70 font-bold uppercase tracking-wider">Pitch Decks Created</p>
              </div>
              <h4 className="text-3xl font-black text-[var(--secondary)] pl-2">{totalPitches}</h4>
            </div>
          </div>

          {/* CENTER COLUMN: Unified Pitch Portfolio & Deal Pipelines */}
