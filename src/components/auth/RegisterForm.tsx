...
export default function RegisterForm() {
  ...
  const [formData, setFormData] = useState({ email: "", password: "", role: "startup" });
    ...
    >
      ...
      <div className="mt-8 text-center space-y-2">
        <p className="text-[11px] font-medium text-[#4A148C]/70">
          Already have an account? <Link href="/login" onClick={() => trackInteraction("CLICK", "nav_login")} className="text-[#81D4FA] font-black hover:underline">Sign In</Link>
        </p>
      </div>
    </motion.div>
  );
